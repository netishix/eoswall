...
export class HomeComponent implements OnInit {
  ...
  public pullSlots() {
    ...
    return eos.getTableRows({
      ...
      .then((globalTable) => {
        const global = globalTable.rows[0];
        this.wall.pixelsSold = global.pixelsSold;
            ...
            this.pullSlots()
              .then(() => {
                ...
                return eos.transaction({
                  actions: [
                    {
                      account: formValue.currency === 'EOS' ? Constants.network.currency.EOS.code : Constants.network.currency.PSO.code,
                      name: 'transfer',
                      authorization: [{
                        actor: account.name,
                      ...
                      data: {
                        ...
                        quantity: formValue.currency === 'EOS' ? slot.eosPrice.toString() : slot.psoPrice.toString(),
